...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Seedin America — Plant the Seed. Grow the Dream." },
      { name: "description", content: "A government-backed initiative providing grant capital to American entrepreneurs building small to large scale businesses." },
      { property: "og:title", content: "Seedin America" },
      { property: "og:description", content: "Government-backed grant capital for American entrepreneurs." },
